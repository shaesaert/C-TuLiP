...
void meas_env(Ctrl_modesImpl *mepl) {
    ...
    } else if  (strcmp("FREEWAY1_LIDON1_STEREO0_RADON0",signame) == 0){
        newEv = Q_NEW(QEvent,FREEWAY1_LIDON1_STEREO0_RADON0_SIG);

    } else if  (strcmp("FREEWAY1_LIDON1_STEREO0_RADON1",signame) == 0){
        newEv = Q_NEW(QEvent,FREEWAY1_LIDON1_STEREO0_RADON1_SIG);

    } else if  (strcmp("FREEWAY1_LIDON1_STEREO1_RADON0",signame) == 0){
        newEv = Q_NEW(QEvent,FREEWAY1_LIDON1_STEREO1_RADON0_SIG);

    } else if  (strcmp("FREEWAY1_LIDON1_STEREO1_RADON1",signame) == 0){
